...
function AddMenuGender(menu)
    local genderItem = NativeUI.CreateItem("Sex", "Toggle the gender of your Character.")
    ...
    menu.OnItemSelect = function(sender, item, index)
        if item == genderItem then
            ...
            -- Update other character values
            Character["ogd"] = string.sub(Character["gender"], 1, 1)
            Character["lcgd"] = Character["ogd"] .. string.sub(Character["gender"], 2)
            oldmdhash = mdhash
